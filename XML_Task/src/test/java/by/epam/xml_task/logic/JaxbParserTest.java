...
public class JaxbParserTest {
    ...
    @Test
    public void testJaxbParserShouldReturnEntitiesFromXmlFileWhenXmlFileValid() throws ParserException {
        //given
        ParserFactory factory = new ParserFactory();
        JaxbParser parser = (JaxbParser) factory.create(ParserType.JAXB_PARSER);
